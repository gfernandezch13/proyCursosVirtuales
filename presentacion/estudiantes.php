              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <p><input type="text" name="txtapellidos" id="txtapellidos" placeholder="Apellidos" required="" class="form-control"></p>
                      <p><input type="text" name="txtnombres" id="txtnombres" placeholder="Nombres" required="" class="form-control"></p>
                      <p><input type="text" name="txtdni" id="txtdni" placeholder="DNI" required="" class="form-control"></p>
                      <p>
                      ...
                      <p><input type="date" name="txtfechanacimiento" id="txtfechanacimiento" placeholder="Fecha de nacimiento" required="" class="form-control"></p>
                      <p><input type="text" name="txtdireccion" id="txtdireccion" placeholder="Dirección" required="" class="form-control"></p>
                      <p><input type="text" name="txttelefono" id="txttelefono" placeholder="Telefono" required="" class="form-control"></p>
                      <p><input type="email" name="txtcorreo" id="txtcorreo" placeholder="Correo" required="" class="form-control"></p>
